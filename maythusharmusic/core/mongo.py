...
from maythusharmusic import config, logger, userbot
...
class MongoDB:
    ...
    async def get_admins(self, chat_id: int, reload: bool = False) -> list[int]:
        from maythusharmusic.helpers._admins import reload_admins
    ...
    async def get_assistant(self, chat_id: int):
        from maythusharmusic import cailin
        ...
        return cailin.clients[self.assistant[chat_id] - 1]
