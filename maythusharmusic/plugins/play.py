...
from maythusharmusic import cailin, app, config, db, lang, queue, tg, yt
from maythusharmusic.helpers import buttons, utils
from maythusharmusic.helpers._play import checkUB
...
async def play_hndlr(
    ...
    await cailin.play_media(chat_id=m.chat.id, message=sent, media=file)
